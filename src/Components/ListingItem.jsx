...
const ListingItem = ({listing,id,onEdit,onDelete}) => {
  return <li className=' relative bg-white flex flex-col justify-between items-center space-x-3
  shadow-md hover:shadow-xl rounded-md overflow-hidden transition-shadow duration-150 m-[10px] '>
        ...
        <div className='w-full p-[10px]'>
            ...
            <div className='flex items-center space-x-1'>
                ...
                <p className=' text-[#457b9d] mt-2 font-semibold'>
                  ₹{listing.Offers ? listing.regularPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",")
    ...
    {onEdit && (<MdEdit className='absolute bottom-2 right-7 h-4 cursor-pointer text-black
