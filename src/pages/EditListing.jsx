...
const EditListing = () => {
    ...
    const {type,name,bedrooms,bathrooms ,description,address,parking,furnished,Offers,
   ...
   <main className='max-w-md px-2 mx-auto '>
        ...
        <form onSubmit={onSubmit}>
            ...
            transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
             ...
             <div className='flex space-x-6 mb-6'>
                <div >
                    ...
                    min="1" max="50" required className='w-full px-4 py-2 text-xl text-gray-700
                    bg-white border border-gray-700 rounded transition duration-150 
                    ease-in-out focus:text-gray-700 focus:bg-white
                     focus:border-slate-600 text-center'></input>
                </div>
            ...
            {!geoLocationEnabled && (
                <div className='flex space-x-6 justify-start mb-6 '>
                    <div className=''>
                        ...
                        value={latitude} onChange={onChange} required min="-180" max="180"

                        className='w-full px-4 py-2 text-xl text-gray-700 bg-white border
                         border-gray-300 rounded transition ease-in-out duration-200 focus:bg-white
                    ...
                    <div className=''>
                        ...
                        value={longitude} onChange={onChange} required
                ...
                <div className=''>
                    ...
                    <div className='flex w-full justify-center items-center space-x-6'>
                        ...
                        <input type="number" id="regularPrice"
                         value={regularPrice} onChange={onChange} min="50" max="4000000000" required
            ...
            {Offers && (
                ...
                <div className=''>
                    ...
                    <div className='flex w-full justify-center items-center space-x-6'>
                        ...
                        value={discountedPrice} onChange={onChange} min="50" max="4000000000" required={Offers}
                        className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 
                        rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white
                        focus:border-slate-600 text-center'/>
           ...
           <div className='mb-6'>
             ...
             <input type="file" name="images" onChange={onChange} accept='.jpg,.png,.jpeg' multiple required
             className='w-full px-3 py-1.5 text-gray-700 bg-white border border-gray rounded transition 
             duration-150 ease-in-out focus:border-slate-600'/>
           </div>
