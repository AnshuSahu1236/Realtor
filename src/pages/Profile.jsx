        ...
        <div className='w-full md:w-[50%] mt-6 px-3'>
          <form>
            ...
            bg-white border border-gray-300 rounded transition ease-in-out
             ${changeDetail && "bg-red-200 focus:bg-red-200"}`}></input>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg mb-6'>
              ...
              <p onClick={onLogout} className='text-blue-500 hover:text-blue-800 transition duration-200 
              ease-in-out cursor-pointer'>Sign Out</p>
              
            </div>
          </form>

          <button type="submit" className='w-full bg-blue-600 text-white uppercase px-7 py-3 text-sm font-medium rounded-md hover:bg-blue-700 transition duration-200 ease-in-out hover:shadow-lg active:bg-blue-800'>
