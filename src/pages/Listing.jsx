...
import {FaParking, FaBath, FaBed, FaMapMarkedAlt, FaShareSquare, FaChair } from 'react-icons/fa';
...
<Swiper
      ...
      <div className='fixed top-[13%] right-[3%] z-10 cursor-pointer border-gray-400 bg-white
      ...
      <div className='m-4 flex flex-col md:flex-col lg:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg border-3 shadow-lg'>
        <div className='w-full '>

            <p className='text-2xl font-bold mb-3 text-blue-900'>
                {listing.name} - ₹{listing.Offers ?listing.regularPrice .toString().replace(/\B(?=(\d{3})+(?!\d))/g,",") 
            ...
            <div className='flex justify-start items-center space-x-4 w-[75%]'>
                ...
                {listing.Offers && (
                    ...
                    rounded-md p-1 text-white text-center font-semibold shadow-md'>₹{ +listing.discountedPrice} discount</p>
                )}
            </div>
            ...
            <ul className='flex space-x-2 items-center sm:space-x-10 text-sm font-semibold mb-6'>
                <li className='flex items-center whitespace-nowrap'>
                    <FaBed className='text-lg mr-1'></FaBed>
